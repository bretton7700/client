   ...
   elevation={0}>
    ...
    justifyContent: 'space-between', gap: '10px', paddingX: '5px'}}>
      <Stack direction="column"  gap={1}>
        ...
        <Stack direction="row"  gap={0.5} alignItems="flex-start"><Place
      ...
      <Box px={1.5} py={0.5} 
      borderRadius={1} bgcolor="#dadefa" height="fit-content">
        <Typography fontSize={12} fontWeight={600} color="#475be8">Ksh{price}</Typography>
      </Box>
    </CardContent>
